...
"""
    ...
    # if extra_scoreB >= 10 or extra_scoreA >= 10:
     #   ball = Ball(RED, 10, 10)
    # else:
     #   ball = Ball(WHITE, 10, 10)
   ...
   # screen.blit(ballimg(0, 0))
    ...
    if scoreA >= 50:
        ...
        text = stat.render("Player Hits : " + str(paddleA_hit_stats), 1, BLUE)
        ...
        # paddleA_miss
        text = stat.render("Player Miss : " + str(paddleA_miss), 1, BLUE)
        screen.blit(text, (110, 165))

        text = stat.render("AI Hits : " + str(paddleB_hit_stats), 1, WHITE)
