...
""" 
ideen var att läga spelet i en class och senare i en funktion för att kunna kalla den när man ville starta om fast detta fungerade inte för att:
    När funktionen skulle kallas när med R tagenten så updaterades inte pöengen.


    "Hoppet" gjordes genom att en funktion kallas när spelaren använder mellanskag och hans "paddle" hoppar fram 80 pixlar och så fort spelaren rör sig kommer den hoppa tillbaka till orginela platsen
    """
